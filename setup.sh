...
echo '                        WELCOME                             '
echo ' .......................................................... '
echo '               Auto Script By Dragonsth                     '
echo '                    MiniScript 2022                         '
echo '                   Contact dragonsth                        '  
echo '............................................................'
echo ''
echo '                      โปรดรอสักครู่..... !                     '
echo ' ..........................................................'
...
echo '============================================='
sleep 3
wget https://raw.githubusercontent.com/dragonsth/install/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
echo '============================================='
echo '        กรุณารอสักครู่....! '
echo '============================================='
...
echo "   - OpenVPN                 : TCP 1194, UDP 2200, SSL 995"  | tee -a log-install.txt
...
echo ""
echo "--------------------------สคริปโดยdragonsth------------------------" | tee -a log-install.txt
echo ""
echo " Reboot 15 Sec"
sleep 15
rm -f setup.sh
